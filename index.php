      ...
      <div class="small-container">
        ...
        <div class="row">
          ...
          while($row = mysqli_fetch_array($result))
          {
            ...
            <button type='submit' class='add-to-cart' name='buy1'>Buy Now</button>
            </div>
            </form>
            ";
          }
        ...
        <div class="footer">
          <div class="container">
            <div class="row">
              ...
              <div class='row' style="color: #73502c; font-size: 20px;">
    <b> Backend is done by  Ashish Bansal </b>
    <b> Frontend is done by  Rahul Sharma </b>
    <b> Frontend is done by  Aman Arya </b>
</div>
              <hr>
